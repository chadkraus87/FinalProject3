...
function ProductPage() {
    ...
    return (
        <div>
            <div style={{ textAlign: 'right', padding: '1%', fontSize: '5vh' }}>
                <AccountBoxIcon style={{ fontSize: '5vh' }} />
                <ShoppingCartIcon style={{ fontSize: '5vh' }} />
                <MenuIcon style={{ fontSize: '5vh' }} />
            </div>
            <div style={{ fontFamily: "'Marck Script', cursive", fontSize: '5rem', textAlign: 'center', color: '#5271FF' }}>Furry Feet Friends</div>
